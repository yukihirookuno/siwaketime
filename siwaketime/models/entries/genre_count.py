...
class Genre_count(Base):
    ...
    def __init__(self, doryoku_count = None, asobi_count =None, muda_count = None
        ):
        self.gannbari_count = doryoku_count,
        self.asobi_count = asobi_count,
        self.muda_count = muda_count

    #def __repr__(self):
    #    return '<Genre_count genre_count_id :{} doryoku_count :{} asobi_count :{} muda_count:{}>'.format(
